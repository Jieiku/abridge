...
description = "Images can be embedded directly using markdown `![Ferris](ferris.svg)`, but using a component prevents CLS by explicitly setting the width and height."
draft = false
...
+++
This post covers the **imgswap and img components**. Images can also be embedded directly using Markdown `![Ferris](ferris.svg)`, but using a component lets you explicitly set the width and height. This helps prevent cumulative layout shift (CLS), improving page stability and potentially improving Lighthouse performance scores.
