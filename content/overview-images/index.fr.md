...
description = "Les images peuvent être intégrées directement à l'aide de markdown `![Ferris](ferris.svg)`, mais l'utilisation d'un component empêche CLS en définissant explicitement la largeur et la hauteur."
draft = false
...
+++
Cet article couvre les **components imgswap et img**. Les images peuvent également être intégrées directement à l'aide de markdown `![Ferris](ferris.svg)`, mais il est préférable d'utiliser un component afin de pouvoir définir explicitement la largeur et la hauteur, cela aidera à empêcher le changement de mise en page du contenu, ce qui améliore l'expérience utilisateur et le score Google Lighthouse.
...
Le composant imgrow place plusieurs composants img ou imgswap côte à côte. Sur les petits écrans, les images s'empilent automatiquement à la verticale.

Une `class` facultative peut être ajoutée au conteneur de la rangée.
...
Les images peuvent également être empilées verticalement en plaçant plusieurs composants img ou imgswap les uns à la suite des autres.
