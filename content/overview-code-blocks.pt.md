...
description = "Artigo de exemplo que demonstra realce de sintaxe e formatação de blocos de código com um tema personalizado."
draft = false
title = "Tema de Blocos de Código"

[extra]
keywords = "Código, Blocos de Código, Sintaxe, Realce de Sintaxe, Tema"
series = "Recursos"
toc = true
...
+++
Este artigo mostra vários blocos de código, permitindo comparar facilmente temas de realce.
